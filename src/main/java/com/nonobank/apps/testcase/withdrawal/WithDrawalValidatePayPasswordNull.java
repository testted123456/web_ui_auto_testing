...
public class WithDrawalValidatePayPasswordNull extends BaseCase {
	public static Logger logger = LogManager.getLogger(WithDrawalValidatePayPasswordNull.class);
	...
	public void test(String mobile, String password, String checkCode, String money, String pay_password) {
		...
		biz_User_WithdrawalConfirm.confirm(pay_password, "请输入支付密码！");
	}
}
