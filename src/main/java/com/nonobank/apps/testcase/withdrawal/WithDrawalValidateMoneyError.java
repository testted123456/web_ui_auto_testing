...
public class WithDrawalValidateMoneyError extends BaseCase {
	public static Logger logger = LogManager.getLogger(WithDrawalValidateMoneyError.class);
	...
	public void test(String mobile, String password, String checkCode, String money, String pay_password) {
		...
		biz_User_Withdrawal.withDrawal(money, "提现金额必须为数字");
	}
}
