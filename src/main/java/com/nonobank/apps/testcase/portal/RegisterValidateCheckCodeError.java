...
public class RegisterValidateCheckCodeError extends BaseCase {
	...
	public void test(String mobile, String user_name, String password, String password2, String checkCode,
			String validation) {
		biz_Register.register(mobile, user_name, password, password2, checkCode, validation, "checkCodeError",
				"验证码输入错误！");
	}
}
