...
public class Login2 extends BaseCase {
	Biz_Portal biz_Portal;
	Biz_Login biz_Login;
	Biz_Account biz_Account;
	public static Logger logger = LogManager.getLogger(Login2.class);
	...
	public void test(String testcaseName, String testcaseDescription, String loginName, String password,
		...
		biz_Portal.test(testcaseName);
	}
	@Test(dataProvider = "dataSource")
	public void test2(String testcaseName, String testcaseDescription, String loginName, String password,
			String checkCode, String expectResult) {
	}
}
