...
public class BindCardSuccess extends BaseCase {
	...
	public void test(String mobile, String user_name, String password, String password2, String check_code, String sms_code,
			String myname, String mycard, String payPassword, String payPassword1,
