...
public class BorrowsExcTestCase extends BaseCase {
	...
	public void test(String userName_exist_register, String userName_register, String qq_exist_register,
			...
			String realName_register, String idCard_exist_register, String major_register, String channel_register,
			String idCard_error_register, String idCard_register, String password_different_register,
			String confirmassword_different_register, String password_register, String confirmassword_register,
			String purpose_apply, String detailPurpose_error_apply, String money_error_apply, String smsCode_apply,
			String detailPurpose_apply, String money_Emergency_apply, String productIndex_large_apply,
			String pieces_large_apply, String money_large_apply, String productIndex_emergency_apply,
			String pieces_emergency_apply, String money_apply, String productIndex_apply, String pieces_apply,
			String email_improve, String address_improve, String income_index_improve, String parentName_improve,
			String parentMobile_error_improve, String counselorName_improve, String counselorMobile_improve,
		...
		biz_Apply.selectBorrowsProductBus(int_money_Emergency_apply, int_productIndex_large_apply,
				int_pieces_large_apply);
		// 申请流程--提交
		biz_Apply.submitBus();
		// 提交：借款需介于1千元~5万元之间
		...
		biz_Apply.selectBorrowsProductBus(int_money_large_apply, int_productIndex_emergency_apply,
				int_pieces_emergency_apply);
		// 申请流程--提交
		biz_Apply.submitBus();
		...
		biz_Improve.personalInformationBus(email_improve, address_improve, income_index_improve, parentName_improve,
				parentMobile_error_improve, counselorName_improve, counselorMobile_improve, friend1Name_improve,
