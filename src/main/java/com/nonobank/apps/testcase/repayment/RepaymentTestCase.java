...
// @Test(dataProvider = "dataSource")
// public void test(String userName_register,String qq_register,String
// mobile_register,
// String checkCode_register,String password_register,String
// confirmPassword_register,
// String province_register,String institution_register,String
// schoolArea_register,
...
// String parentName_improve,String parentMobile_improve,String
// counselorName_improve,
// String counselorMobile_improve,String friend1Name_improve,
// String friend1Mobile_improve,String friend2Name_improve,String
// friend2Mobile_improve,
// String friend3Name_improve,String friend3Mobile_improve,String file_improve,
// String bankcardAccount_improve,String banksType_improve,String
// bankMobile_improve,
...
//
// // 注册流程--注册信息
// biz_register.registerInformationBus(userName_register, qq_register,
// mobile_register,
// checkCode_register, smsCode_register, password_register,
// confirmPassword_register);
// // 注册流程--信息验证
// biz_register.informationVerifyBus(province_register, institution_register,
// schoolArea_register,
...
//
// //申请流程--借款用途、金额
// biz_Apply.borrowsUseBus(purpose_apply, detailPurpose_apply, int_money_apply,
// smsCode_apply);
// //申请流程--借款产品
// biz_Apply.selectBorrowsProductBus(int_money_apply, int_productIndex_apply,
// int_pieces_apply);
// //申请流程--提交
// biz_Apply.submitBus();
// biz_Apply.submitAfterVerify(int_productIndex_apply, int_pieces_apply,
// int_money_apply);
// PageUtils.sleep(5000);
// //申请流程--镑客码验证框存在通过
// biz_Apply.bankCodeVerifyBus();
...
// income_index_improve,
// parentName_improve, parentMobile_improve, counselorName_improve,
// counselorMobile_improve,
// friend1Name_improve, friend1Mobile_improve, friend2Name_improve,
// friend2Mobile_improve,
// friend3Name_improve, friend3Mobile_improve);
// //完善资料--上传身份证照片
// biz_Improve.uploadingBus(file_improve);
// //完善资料--完善银行卡信息
// biz_Improve.bankCardBus(bankcardAccount_improve, banksType_improve,
...
//
// //视频录制--借款信息检查
// biz_VideoSign.videoSignInformationCheckBus(realName_register,
// idCard_register, int_money_apply);
// //视频录制--终审通过
