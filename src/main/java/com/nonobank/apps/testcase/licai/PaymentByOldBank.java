 ...
 *
 */
public class PaymentByOldBank extends BaseCase {
	...
	public void test(String testcaseName, String testcaseDescription, String mobile, String password, String checkCode,
			String id, String amount, String payPassword, String expectMessage) {
		...
		biz_Licai_Payment.payByOldNewCard(payPassword);
