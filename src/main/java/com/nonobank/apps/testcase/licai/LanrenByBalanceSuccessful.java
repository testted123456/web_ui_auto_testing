 ...
 *
 */
public class LanrenByBalanceSuccessful extends BaseCase {

	public static Logger logger = LogManager.getLogger(LanrenByBalanceSuccessful.class);
	Biz_Login biz_Login;
	...
	public void test(String mobile, String password, String checkCode, String cardno, String money, String pay_password,
			String bankName,String id, String amount) {
