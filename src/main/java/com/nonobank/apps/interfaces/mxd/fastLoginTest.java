...
public class fastLoginTest {
	...
	public static String url = "https://openapi.stb.nonobank.com/nono-web/app5/fastLogin";
	
	
	public static String fastLogin(String mobile,String smsCode){
		// 生成msgKey
