...
public class Page_User_RechargeConfirm extends BasePage {
	...
	public void input_smsCode(String smsCode) {
		if (objectFactory.isElementExists("validnum", WebElementType.WebInput)) {
	...
	public void submit_smsCode() {
		if (objectFactory.isElementExists("btn_submit", WebElementType.WebInput)) {
	...
	public String getCounterFee() {
		...
		if (objectFactory.isElementExists(By.xpath("//b[@id='counterfee']"))) {
	...
	public boolean isRechargeConfirmSuccess(String money, String counterFee) {
		if (isDisplayed(WebElementType.WebLink, "rechargebtn")) {
