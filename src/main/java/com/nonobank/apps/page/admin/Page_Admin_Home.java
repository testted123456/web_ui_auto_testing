...
public class Page_Admin_Home extends BasePage {

	public static Logger logger = LogManager.getLogger(Page_Admin_Home.class);
	...
	public void click_videoAduditView(String username, String audit) {
		...
		String path =  "/Admin/Audit/VideoAuditView/"
				+ user_id + "/" + borrows_id;
