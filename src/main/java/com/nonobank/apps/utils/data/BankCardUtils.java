...
public class BankCardUtils {
	// 436742121737-建设银行---------------快钱通道	CCB
	// 622696779515-中信银行-连连通道			CITIC
	// 622632349194-华夏银行-连连通道			HXB
	// 622568683546-广发银行 ---------------快钱通道	GDB
	// 622298316429-平安银行 ------快钱通道	PAB

	// 622827469345-农业银行---------------块钱通道	ABC
	// 620061511669-中国银行-连连通道			BOC
	// 621485021040-招商银行-连连通道			CMB
	// 622660633366-光大银行-连连通道			CEB
	// 622262406933-交通银行-连连通道			BCOM

	// 621691506392-民生银行-连连通道			CMBC
	// 622521071652-浦发银行-连连通道			SPDB
	// 622202100112-工商银行 ---------------快钱通道	ICBC
	// 622908192090-兴业银行---------------快钱通道	CIB
	// 621799417365-邮政储蓄-连连通道			PSBC
	...
	public static String getUsedBankCard(String bankCode) {
		String sql = "select ubi.bank_card_no from user_info ui, user_bankcard_info ubi where  ui.id=ubi.user_id WHERE bank_code ='" + bankCode + "'  limit 1";
		Connection con = DBUtils.getConnection("nono");
		String cardno = DBUtils.getOneObject(con, sql).toString();
		DBUtils.closeConnection();
		return cardno;
