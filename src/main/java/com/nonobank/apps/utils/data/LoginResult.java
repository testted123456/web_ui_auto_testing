...
public enum LoginResult {
	SUCESS(1, "登录成功", null, ConstantUtils.CORRECT_CHECK_CODE), LOGINNAME_NULL(2, "请输入您的用户名或手机号！", "反例——检查登录用户名为空脚本",
			ConstantUtils.CORRECT_CHECK_CODE), LOGINPWD_NULL(3, "请输入您的登录密码！", "反例——检查密码为空脚本",
